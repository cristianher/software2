class InformationController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @information.save
        format.html { redirect_to @information, notice: 'La información ha sido creada.' }
  ...
  def update
    respond_to do |format|
      if @information.update(information_params)
        format.html { redirect_to @information, notice: 'La información ha sido actualizda.' }
  ...
  def destroy
    @information.destroy
    respond_to do |format|
      format.html { redirect_to information_index_url, notice: 'La información ha sido actualizada.' }
