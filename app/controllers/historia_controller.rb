class HistoriaController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @historium.save
        format.html { redirect_to @historium, notice: 'La Historia ha sido creada.' }
  ...
  def update
    respond_to do |format|
      if @historium.update(historium_params)
        format.html { redirect_to @historium, notice: 'La Historia ha sido actualizada.' }
  ...
  def destroy
    @historium.destroy
    respond_to do |format|
      format.html { redirect_to historia_url, notice: 'La Historia ha sido eliminada.' }
  ...
  private
    ...
    def historium_params
      params.require(:historium).permit(:body)
    end
end
