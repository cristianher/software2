class EntrancesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @entrance.save
        format.html { redirect_to @entrance, notice: 'La entrada ha sido creada.' }
  ...
  def update
    respond_to do |format|
      if @entrance.update(entrance_params)
        format.html { redirect_to @entrance, notice: 'La entrada ha sido actualizada.' }
  ...
  def destroy
    @entrance.destroy
    respond_to do |format|
      format.html { redirect_to entrances_url, notice: 'La entrada ha sido eliminada.' }
  ...
  private
    ...
    def entrance_params
      params.require(:entrance).permit(:email, :clase, :level, :description, :location)
    end
end
